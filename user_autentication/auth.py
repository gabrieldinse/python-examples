...
class Authenticator:
    ''' Create and authenticate users in the system '''
    ...
    def add_user(self, username, password):
        ...
        # We can test if the username alreay exists using if or a try block
        # (see 'login' instance method)
...
# autenticador default
authenticator = Authenticator()


class Authorizor:
    ''' Manage registered users permissions '''
    ...
    def add_permission(self, permission_name):
        ...
        try:
            perm_name = self.permissions[permission_name]
        except KeyError:
    ...
    def permit_user(self, permission_name, username):
        ''' Grants the user the given permission '''
...
# authorizor gets a reference to an Authenticator object and follows its
# changes
